...
js=(out/'app.js').read_text().replace('Demo mode: model decisions and outgoing notifications are simulated. Use Rehearsal to test a workflow.', 'Public demo: fictional data and simulated actions. Changes stay in this browser. Use Rehearsal to explore the agent workflow.')
